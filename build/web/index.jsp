                            ...
                            <div class="hero__item" style="">
                                <div class="hero__item-img">
                                    <img src="assets/img/banner/banner.jpg" alt="">
                                        <img src="images/Simple Modern Photo Collage Autumn Fashion Sale Banner.png" alt=""/>
                                </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <c:forEach items="${listTop}" var="o">
                            <div class="col-lg-3">
                                <h5>Shop: <strong>${o.storeName}</strong></h5>
                                <div class="categories__item set-bg"">
                                    <img src="${o.imageLink}"/>
                                    <h5>
                                        <a href="detail?productID=${o.productID}&storeID=${o.storeID}">
                                            ${o.productName}
                            ...
                            <div class="featured__item">
                                ...
                                <div class="featured__item__pic set-bg">
                                    ...
                                    <ul class="featured__item__pic__hover">
                                        ...
                                        <li><a href="add-cart?productID=${o.productID}&storeID=${o.storeID}&quantity=1"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                                <div class="featured__item__text">
                                    <h6><a href="detail?productID=${o.productID}&storeID=${o.storeID}">${o.productName}</a></h6>
                                    <h5>${o.priceWithDot} VND</h5>
                                </div>
                            </div>
                        </div>
                    </c:forEach>                   
